...
#define MTDPARTS_DEFAULT	"mtdparts=s3c-nand:512k(bootloader)"\
				",128k(device_tree)"\
				",5m(kernel)"\
				",-(file system)"
...
#define CONFIG_IPADDR		10.211.55.31
#define CONFIG_SERVERIP     10.211.55.26
#define CONFIG_GATEWAYIP    10.211.55.1
...
#define PHYS_SDRAM_1_SIZE	0x08000000*2	/* 128*2 MB in Bank #1	*/
